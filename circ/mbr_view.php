...
<form name="barcodesearch" method="POST" action="../circ/checkout.php">
    ...
    <table class="primary">
        ...
        <tr>
            <td nowrap="true" class="primary">
                <table class="primary">
                    ...
                    <tr>
                        <td class="borderless"><span id="duedate1"
                                                     style="display:none"><?php echo $loc->getText("Due Date:"); ?></td>
                        <td class="borderless">
                            <small id="duedateoverride"><a
                                        href="javascript:showDueDate()"><?php echo $loc->getText("Override Due Date"); ?></a></small>
        ...
        ?>
                        ...
                        <td>
                            <span id="duedate3" style="display:none"><input type="button"
                                                                            value="<?php echo $loc->getText("Cancel"); ?>"
                                                                            class="button"
                                                                            onclick="hideDueDate()"/></span>
                        </td>
                    </tr>
                </table>
            </td>
    ...
    if ($biblioQ->getRowCount() == 0) {
        ...
        while ($biblio = $biblioQ->fetchRow()) {
            ...
            <tr>
                ...
                <td class="primary" valign="top">
                    <img src="../images/<?php echo HURL($materialImageFiles[$biblio->getMaterialCd()]); ?>" width="20"
