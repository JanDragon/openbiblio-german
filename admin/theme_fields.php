...
<table class="primary">
    ...
    <tr>
        <td align="center" colspan="5" class="primary">
            <input type="button" onClick="javascript:editTheme()"
                   value="  <?php echo $loc->getText("adminSubmit"); ?>  " class="button">
            <input type="button" onClick="self.location='../admin/theme_list.php'"
