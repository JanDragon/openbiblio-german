...
$trans["&laquo;Prev"]              = "\$text = '&laquo;Zur�ck';";
$trans["Next&raquo;"]              = "\$text = 'N�chster&raquo;';";
...
$trans["overdueList"]              = "\$text = 'Benutzer mit �berf�lligen Medien';";
$trans["balanceDueList"]           = "\$text = 'Benutzer mit offenen Betr�gen';";
$trans["Acquisition"]              = "\$text = 'Erwerbungen';";
$trans["Duplicate Titles"]         = "\$text = 'Doppelte Titel';";
$trans["Periodic Checkout Count"]  = "\$text = 'Periodischer Ausleihz�hler';";
$trans["Copy Search"]              = "\$text = 'Exemplarsuche';";
$trans["Inventory List"]           = "\$text = 'Inventurliste';";
$trans["Biblio List"]              = "\$text = 'Gesamt�bersicht der Medien';";
$trans["Return"]    	           = "\$text = 'R�ckgaben';";
...
$trans["Due before"]               = "\$text = 'Zur�ck vor';";
...
$trans["Date of Return"]           = "\$text = 'R�ckgabedatum';";
$trans["Name Contains"]            = "\$text = 'Name enth�lt';";
$trans["Address or Phone or Email Contains"] = "\$text = 'Adresse, Telefonnummer oder Mail enth�lt';";
$trans["Newer than (Date or today)"] = "\$text = 'Neuer als (Datum oder today)';";
...
$trans["biblio.last_change_dt"]    = "\$text = 'Letzte �nderung';";
...
$trans["biblio_copy.due_back_dt"]       = "\$text = 'R�ckgabedatum';";
...
$trans["settings.library_hours"]   = "\$text = '�ffnungszeiten';";
$trans["settings.library_phone"]   = "\$text = 'Bibliothekstelefon';";
$trans["days_late"]                = "\$text = '�berf�llige Tage';";
$trans["title"]                    = "\$text = 'Titel';";
$trans["author"]                   = "\$text = 'Autor';";
$trans["due_back_dt"]              = "\$text = 'R�ckgabe';";
