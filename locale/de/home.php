...
$trans["indexCircDesc2"]     = "\$text='Mitglieder-Verwaltung (Neu, Suche, Bearbeiten, L�schen)';";
$trans["indexCircDesc3"]     = "\$text='Ausleihe, Vorbestellungen, Geb�hrenverwaltung und History der Mitglieder';";
$trans["indexCircDesc4"]     = "\$text='Medienr�ckgabe und Eingangsablage';";
...
$trans["indexCatDesc2"]      = "\$text='Medien-Verwaltung (Neu, Suche, Bearbeiten, L�schen)';";
//$trans["indexCatDesc3"]      = "\$text='Import bibliography from USMarc record';";
$trans["indexAdmin"]         = "\$text='Admin';";
$trans["indexAdminDesc1"]    = "\$text='Benutzen Sie diesen Reiter um die Mitarbeiter zu verwalten und die Programmeinstellungen zu �ndern.';";
$trans["indexAdminDesc2"]    = "\$text='Mitarbeiter Verwaltung (Neu, Bearbeiten, Passwort, L�schen)';";
...
$trans["indexReportsDesc1"]  = "\$text='Benutzen Sie diesen Reiter um Berichte �ber die Daten zu erstellen.';";
