...
$trans["circDelete"]              = "\$text = 'L�schen';";
$trans["circLogout"]              = "\$text = 'Ausloggen';";
$trans["circAdd"]                 = "\$text = 'Hinzuf�gen';";
...
$trans["mbrNewForm"]              = "\$text='F�ge hinzu neuen';";
...
$trans["mbrFldsSubmit"]           = "\$text='�bermitteln';";
...
#****************************************************************************
$trans["mbrNewSuccess"]           = "\$text='Benutzer wurde erfolgreich hinzugef�gt.';";

#****************************************************************************
#*  Translation text for page mbr_edit.php
#****************************************************************************
$trans["mbrEditSuccess"]          = "\$text='Benutzer wurde erfolgreich aktualisiert.';";
$trans["mbrRenewSuccess"]         = "\$text='Die Mitgliedschaft wurde erfolgreich um %length% Monate verl�ngert.';";
$trans["All items renewed."]      = "\$text='Alle Medien verl�ngert.';";
...
$trans["mbrViewStatColHdr5"]      = "\$text='Verl�ngerung';";
...
$trans["mbrViewOutHdr10"]         = "\$text='R�ckgabe';";
...
$trans["Renew All"]	  	  = "\$text='Alle Medien verl�ngern';";
$trans["mbrViewDel"]              = "\$text='L�sche';";
$trans["mbrViewRenew1"]           = "\$text='Verl�ngere Mitgliedschaft um';";
...
$trans["Override Due Date"]       = "\$text='R�ckgabedatum manuell �ndern';";
$trans["Cancel"]                  = "\$text='Abbrechen';";

#****************************************************************************
#*  Translation text for page checkout.php
#****************************************************************************
$trans["checkoutBalErr"]          = "\$text='Der Benutzer mu� ausstehende Geb�hren zahlen, bevor er ausleihen darf.';";
...
$trans["checkoutErr6"]            = "\$text='Der Benutzer hat das Ausleihlimit f�r diese Medienart bereits erreicht.';";
$trans["checkoutErr7"]            = "\$text='Das Medium mit der Nummer %barcode% kann vom Benutzer nicht nochmal verl�ngert werden.';";
$trans["checkoutErr8"]            = "\$text='Das Medium mit der Nummer %barcode% kann nicht verl�ngert werden, weil es schon versp�tet ist.';";
...
$trans["Checked in %barcode% for "]    = "\$text='Exemplar %barcode% zur�ckgenommen von ';";
$trans["Checked in %barcode%."]   = "\$text='Exemplar %barcode% zur�ckgenommen.';";
$trans["checkinEndErr"]          = "\$text='Die Mitgliedschaft ist abgelaufen. Das Mitglied muss entweder die Mitgliedschaft verl�ngern oder f�r %monthlate% Monate nachzahlen.';";

#****************************************************************************
#*  Translation text for page checkin.php
#****************************************************************************
$trans["checkinErr1"]             = "\$text='Keine Medien wurden ausgew�hlt.';";

#****************************************************************************
#*  Translation text for page hold_message.php
#****************************************************************************
$trans["holdMessageHdr"]          = "\$text='Medium wurde vorbestellt!';";
$trans["holdMessageMsg1"]         = "\$text='Das Medium mit der Mediennummer %barcode% welches Sie eincecken wollen wurde vorbestellt. <b>Bitte das Medium ins Vorbestellfach legen und nicht in die Eingangsablage.</b> Der Statuscode des Medium wurde auf vorbestellt ge�ndert.';";
$trans["holdMessageMsg2"]         = "\$text='Kehre zur Medienr�ckgabe zur�ck.';";
...
#****************************************************************************
$trans["mbrDelConfirmWarn"]       = "\$text = 'Der Benutzer, %name%, hat %checkoutCount% Ausleihe(n) und %holdCount% Vorbestellung(en). Alle ausgeliehenen Medien m�ssen zur�ckgegeben und alle Vorbestellungen gel�scht werden, um den Benutzer zu l�schen.';";
$trans["mbrDelConfirmReturn"]     = "\$text = 'Kehre zur Benutzerinformation zur�ck';";
$trans["mbrDelConfirmMsg"]        = "\$text = 'Sind sie sicher, da� sie den Benutzer %name% l�schen wollen? Dieses wird auch die Ausleihhistory von ihm l�schen.';";

#****************************************************************************
#*  Translation text for page mbr_del.php
#****************************************************************************
$trans["mbrDelSuccess"]           = "\$text='Der Benutzer, %name%, wurde gel�scht.';";
$trans["mbrDelReturn"]            = "\$text='kehre zur Benutzersuche zur�ck';";
...
$trans["mbrHistoryHdr5"]          = "\$text='Datum der Status�nderung';";
$trans["mbrHistoryHdr6"]          = "\$text='R�ckgabedatum';";

#****************************************************************************
#*  Translation text for page mbr_account.php
#****************************************************************************
$trans["mbrAccountLabel"]         = "\$text='F�ge eine Transaktion hinzu:';";
...
$trans["mbrAccountDel"]           = "\$text='L�sche';";
...
#****************************************************************************
$trans["mbrTransactionSuccess"]   = "\$text='Transaktion erfolgreich durchgef�hrt.';";

#****************************************************************************
#*  Translation text for page mbr_transaction_del_confirm.php
#****************************************************************************
$trans["mbrTransDelConfirmMsg"]   = "\$text='Sind Sie sicher, da� Sie die Transaktion l�schen wollen?';";

#****************************************************************************
#*  Translation text for page mbr_transaction_del.php
#****************************************************************************
$trans["mbrTransactionDelSuccess"] = "\$text='Transaktion erfolgreich gel�scht.';";
...
$trans["Command Sheet"]     = "\$text='Kommando�bersichtsblatt';";
$trans["Actions which did not produce an error have completed. Think carefully before uploading the same file again, or some circulations may be recorded twice."]     = "\$text='Aktionen die keinen Fehler produzieren wurden ausgef�hrt. Passen Sie auf, dass Sie keine Datei doppelt hochladen, da sonst einige Ausleihen doppelt erfasst werden.';";
