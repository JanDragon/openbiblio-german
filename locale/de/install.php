...
$trans["indexInstr4"]           = "\$text='Schauen Sie f�r mehr Details auch';";
...
$trans["installAlready"]        = "\$text='ist bereits installiert. Sind Sie sicher, da� sie alle Daten l�schen und neue Tabellen erstellen wollen?';";
$trans["installCont"]           = "\$text='Weiter';";
$trans["installStop"]           = "\$text='Abbrechen';";
$trans["installTable"]          = "\$text='Tabelle ';";
$trans["installDel"]            = "\$text=' gel�scht';";
$trans["installTaCrea"]         = "\$text=' erstellt';";
$trans["installTable2"]         = "\$text='Daten f�r die Tabelle ';";
$trans["installIns"]            = "\$text=' eingef�gt.';";
...
$trans["UpdateDel"]             = "\$text=' gel�scht';";
$trans["UpdateTaCrea"]          = "\$text=' erstellt';";
$trans["UpdateTable2"]          = "\$text='Daten f�r die Tabelle ';";
$trans["UpdateIns"]             = "\$text=' eingef�gt.';";
...
$trans["UpdateConv4"]           = "\$text='Neue Mitarbeiter Tabelle, Zeilen gel�scht.';";
$trans["UpdateConv5"]           = "\$text='Mitarbeiter Tabelle konvertiert.';";
$trans["UpdateConv6"]           = "\$text='Neue Genre Tabelle, Zeilen gel�scht.';";
$trans["UpdateConv7"]           = "\$text='Genre Tabelle konvertiert.';";
$trans["UpdateConv8"]           = "\$text='Neue Medientyp Tabelle, Zeilen gel�scht.';";
$trans["UpdateConv9"]           = "\$text='Medientyp Tabelle konvertiert.';";
$trans["UpdateConv10"]          = "\$text='Neue Einstellungentabelle, Zeilen gel�scht.';";
$trans["UpdateConv11"]          = "\$text='Einstellungen Tabelle konvertiert.';";
$trans["UpdateConv12"]          = "\$text='Statustabelle wurde gel�scht.';";
